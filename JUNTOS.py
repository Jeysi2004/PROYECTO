...
total=0
while True:
    print("""BIENVENIDO AL SENATI SHOP
|=============================|
|          GÉNERO             |    
|=============================|
| A |MUJER                    |
...
print("|=============================|")
neto=vestidoss+blusass+cardiganss+faldass+poloss+polerass+pantaloness+casacass
print(vestidoss);print(blusass);print(cardiganss);print(faldass);print(poloss);print(polerass);print(pantaloness);print(casacass)
